<!-- vendored from syncytium2/murderboard @ fae0eca — canonical source; do NOT edit here, update upstream (syncytium2/murderboard docs/session_protocol.md) and re-copy -->
