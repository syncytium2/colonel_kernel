<!-- vendored from syncytium2/murderboard @ a24153f — canonical source; do NOT edit here, update upstream (syncytium2/murderboard docs/session_protocol.md) and re-copy -->
